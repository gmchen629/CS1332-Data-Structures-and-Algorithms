...
public class ArrayListStudentTest {
    ...
    @Test(timeout = TIMEOUT)
    public void testRemoveAllElementsAndRemoveFromEmptyList() {
        list.addAtIndex(0, "0a"); // 0a
        list.addAtIndex(1, "1a"); // 0a, 1a
        list.addAtIndex(2, "2a"); // 0a, 1a, 2a
        list.addAtIndex(3, "3a"); // 0a, 1a, 2a, 3a
        ...
        assertSame(list.get(0), list.removeFromFront()); // 1a, 2a, 3a, 4a
        assertSame(list.get(0), list.removeFromFront()); // 2a, 3a, 4a
        assertSame(list.get(0), list.removeFromFront()); // 3a, 4a
        assertSame(list.get(0), list.removeFromFront()); // 4a
        assertSame(list.get(0), list.removeFromFront()); //
        assertEquals(0, list.size());
        try{
            assertSame(null, list.removeFromFront());
            fail("should have thrown an exception");
        } catch(Exception e) {
            String exceptionMessage = "list is empty";
        }
        assertEquals(0, list.size());
        ...
        assertSame(list.get(list.size()-1), list.removeFromBack()); // 1a, 2a, 3a, 4a
        assertSame(list.get(list.size()-1), list.removeFromBack()); // 2a, 3a, 4a
        assertSame(list.get(list.size()-1), list.removeFromBack()); // 3a, 4a
        assertSame(list.get(list.size()-1), list.removeFromBack()); // 4a
        assertSame(list.get(list.size()-1), list.removeFromBack()); //
        assertEquals(0, list.size());
        try{
            assertSame(null, list.removeFromBack());
            fail("should have thrown an exception");
        } catch(Exception e) {
            String exceptionMessage = "list is empty";
        }
    ...
    @Test(timeout = TIMEOUT)
    public void testAddAtIndexCustom() {
        list.addAtIndex(0, "0a");   // 0a
        list.addAtIndex(1, "1a");   // 0a, 1a
        list.addAtIndex(2, "2a");   // 0a, 1a, 2a
        list.addAtIndex(3, "3a");   // 0a, 1a, 2a, 3a
